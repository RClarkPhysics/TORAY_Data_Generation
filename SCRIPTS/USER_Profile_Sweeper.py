            ...
            for ne in ne_scales:
                for p in POLS:
                    for t in TORS:
                        ...
                        if 'TORAY_'+str(ShotNum)+'_'+str(r)+'_'+str(p_degree)+'_'+str(t_degree)+'_'+str(ne)+'_'+str(te) not in OMFIT['DATA_STORAGE'].keys():
                            OMFIT['DATA_STORAGE']['TORAY_'+str(ShotNum)+'_'+str(r)+'_'+str(p_degree)+'_'+str(t_degree)+'_'+str(ne)+'_'+str(te)] = OMFITtree()
